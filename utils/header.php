        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right"><!--navigation-->
                ...
                if(is_logged_in()){
                    ...
                    echo '<li><a href = "organiser.php">Organiser</a></li>';
    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1>Wedding Event Catalog</h1><!--jumbotron heading-->
                <p>
                Today, it is not easy to organize a function without the engagement of a creative and skilled wedding planner. We are there to resolve your wedding issues and deliver top-notch services for an unforgettable event. Choose yours to embark on an exciting journey with us.Our dedicated ROP'S team can create a package that will meet
                your every need.
                </p>
                <p id="dateAndTime"></p>
            </div>
